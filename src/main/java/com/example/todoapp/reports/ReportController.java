...
public class ReportController {
    ...
    private final PersistentTaskEventRepository eventRepository;

    public ReportController(TaskRepository taskRepository, PersistentTaskEventRepository eventRepository) {
    ...
    public static class TaskWithChangesCount{
