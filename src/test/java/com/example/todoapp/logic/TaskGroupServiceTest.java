...
class TaskGroupServiceTest {
    ...
    void toggleGroup_undoneTasks_throwsIllegalStateException(){
        ...
        assertThat(exception)
                ...
                .hasMessage("Group has undone tasks. Dona all the tasks first");
    }
    ...
    void toogleGroup_wrongId_throwsIllegalArgumentException(){
        ...
        assertThat(exception)
                ...
                .hasMessage("TaskGroup with given not found");
    }
    ...
    private TaskRepository taskRepositoryReturning(boolean result) {
        ...
        when(mockTaskRepository.existByDoneIsFalseAndGroup_Id(anyInt())).thenReturn(result);
